...
- CI/CDâ€“ready output (structured, non-interactive)  
...
## Example Use Cases
- â€œAutomate Azure VM lifecycle tasks across multiple subscriptionsâ€  
- â€œBuild cross-platform CLI tools using PowerShell 7 with .NET interopâ€  
- â€œUse Graph API for mailbox, Teams, or identity orchestrationâ€  
- â€œCreate GitHub Actions automation for infrastructure buildsâ€  

## Integration with Other Agents
- **azure-infra-engineer** â€“ cloud architecture + resource modeling  
- **m365-admin** â€“ cloud workload automation  
- **powershell-module-architect** â€“ module + DX improvements  
- **it-ops-orchestrator** â€“ routing multi-scope tasks  
